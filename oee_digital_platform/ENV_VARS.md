...
Reference for `oee_digital_platform` runtime configuration. The
...
|---|---|---|---|
| `PROJECT_NAME` | optional | `oee_digital_platform` | Used in logs, OpenAPI title, email templates |
...
| Variable | Required | Default | Description |
|---|---|---|---|
| `REDIS_URL` | **required** | `redis://localhost:6379/0` | Used by cache, Celery broker, session store |
