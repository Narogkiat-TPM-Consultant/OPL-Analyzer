...
**oee_digital_platform** - FastAPI application generated with [Full-Stack AI Agent Template](https://github.com/vstorm-co/full-stack-ai-agent-template).
...
# RAG
uv run oee_digital_platform rag-collections
uv run oee_digital_platform rag-ingest /path/to/file.pdf --collection docs
uv run oee_digital_platform rag-search "query" --collection docs

# Sync Sources
uv run oee_digital_platform cmd rag-sources
uv run oee_digital_platform cmd rag-source-add
uv run oee_digital_platform cmd rag-source-sync
```
