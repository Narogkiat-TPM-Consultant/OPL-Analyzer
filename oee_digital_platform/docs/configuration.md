...
|----------|---------|-------------|
| `PROJECT_NAME` | `oee_digital_platform` | Display name for the project |
...
| `POSTGRES_DB` | `oee_digital_platform` | Database name |
...
| `LOGFIRE_SERVICE_NAME` | `oee_digital_platform` | Service name in Logfire dashboard |
