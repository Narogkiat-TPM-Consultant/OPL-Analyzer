...
Run with: `uv run oee_digital_platform cmd my-command --name test`
...
# Or use CLI
uv run oee_digital_platform db migrate -m "Add notifications table"
uv run oee_digital_platform db upgrade
```
