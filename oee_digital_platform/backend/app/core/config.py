...
class Settings(BaseSettings):
    ...
    PROJECT_NAME: str = "oee_digital_platform"
    ...
    LOGFIRE_SERVICE_NAME: str = "oee_digital_platform"
    ...
    POSTGRES_DB: str = "oee_digital_platform"
    ...
    EMAIL_FROM: str = "noreply@oee_digital_platform.com"
    EMAIL_FROM_NAME: str = "oee_digital_platform"
